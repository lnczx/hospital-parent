...
<link rel="stylesheet" type="text/css" href="<c:url value='/lib/Hui-iconfont/1.0.7/iconfont.css'/>" />
<link rel="stylesheet" type="text/css" href="<c:url value='/lib/icheck/icheck.css'/>" />
