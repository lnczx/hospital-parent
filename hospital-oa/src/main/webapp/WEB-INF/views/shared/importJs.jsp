...
<script type="text/javascript" src="<c:url value='/lib/layer/2.1/layer.js'/>"></script>
<script type="text/javascript" src="<c:url value='/lib/moment-2.7.1/moment.min.js'/>"></script>
