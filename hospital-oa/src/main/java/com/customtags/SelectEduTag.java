...
public class SelectEduTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		try {
			...
			List<Dicts> optionList = dictService.LoadEduData();

			StringBuffer selectHtml = new StringBuffer();
			selectHtml.append("<select id = \"eduId\" name=\"eduId\" class=\"select\">");

			if (hasAll.equals("1")) {
				selectHtml.append("<option value='0' >学历</option>");
			}
