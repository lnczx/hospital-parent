...
public class SelectCityTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		try {
			...
			List<Dicts> optionList = dictService.LoadCityData();

			StringBuffer selectHtml = new StringBuffer();
			selectHtml.append("<select id = \"cityId\" name=\"cityId\" class=\"select\">");

			if (hasAll.equals("1")) {
				selectHtml.append("<option value='0' >选择城市</option>");
			}
