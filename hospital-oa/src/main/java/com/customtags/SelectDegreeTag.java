...
public class SelectDegreeTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		try {
			...
			List<Dicts> optionList = dictService.LoadDegreeData();

			StringBuffer selectHtml = new StringBuffer();
			selectHtml.append("<select id = \"degreeId\" name=\"degreeId\" class=\"select\">");

			if (hasAll.equals("1")) {
				selectHtml.append("<option value='0' >学位</option>");
			}
