...
public class SelectCourseTypeTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		try {
			...
			List<Dicts> optionList = dictService.LoadCourseTypeData();

			StringBuffer selectHtml = new StringBuffer();
			selectHtml.append("<select id = \"subjectId\" name=\"subjectId\" class=\"select\">");

			if (hasAll.equals("1")) {
				selectHtml.append("<option value='0' >课程类型</option>");
			}
