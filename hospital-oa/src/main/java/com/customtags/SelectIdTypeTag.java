...
public class SelectIdTypeTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		try {
			...
			List<Dicts> optionList = dictService.LoadIdTypeData();

			StringBuffer selectHtml = new StringBuffer();
			selectHtml.append("<select id = \"idType\" name=\"idType\" class=\"select\">");

			if (hasAll.equals("1")) {
				selectHtml.append("<option value='0' >证件类型</option>");
			}
