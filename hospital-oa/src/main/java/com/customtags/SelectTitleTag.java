...
public class SelectTitleTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		try {
			...
			List<Dicts> optionList = dictService.LoadTitleData();

			StringBuffer selectHtml = new StringBuffer();
			selectHtml.append("<select id = \"titleId\" name=\"titleId\" class=\"select\">");

			if (hasAll.equals("1")) {
				selectHtml.append("<option value='0' >职称</option>");
			}
